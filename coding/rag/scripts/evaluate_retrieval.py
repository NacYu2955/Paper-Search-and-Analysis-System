...
def main():
    ...
    for retrieval_mode in run_modes:
        ...
        report_metrics_csv_path = os.path.join(args.output_dir, f"{run_name}_report_metrics.csv")

        candidate_report_metrics = build_report_metrics(
            candidate_metrics,
            mean_latency,
        )
        final_report_metrics = build_report_metrics(
            final_metrics,
            mean_latency,
        )

        print("\nReport metrics")
        print(format_report_metric_line("Candidate", candidate_report_metrics))
        print(format_report_metric_line("Final", final_report_metrics))
        ...
        summary = {
            ...
            "candidate_report_metrics": candidate_report_metrics,
            "final_report_metrics": final_report_metrics,
        }
        ...
        write_report_metrics_csv(report_metrics_csv_path, [summary])
        ...
        print(f"Report metrics CSV: {report_metrics_csv_path}")
    ...
    if len(all_summaries) > 1:
        ...
        aggregate_report_csv_path = os.path.join(args.output_dir, f"{aggregate_name}_report_metrics.csv")
        write_metrics_csv(aggregate_csv_path, all_summaries)
        write_report_metrics_csv(aggregate_report_csv_path, all_summaries)
        print(f"\nAggregate metrics CSV: {aggregate_csv_path}")
        print(f"Aggregate report metrics CSV: {aggregate_report_csv_path}")
